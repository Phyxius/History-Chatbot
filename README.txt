...
How to build: open the included IntelliJ project and build it, or manually the .java files and copy the contents of the "language" folder into the same directory as the resulting .class files
